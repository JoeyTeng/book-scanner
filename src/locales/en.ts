...
export const en = {
  ...
  'dataManagement.googleDrive.title': 'Google Drive Sync',
  'dataManagement.googleDrive.description': 'Sync full backups to Google Drive app data storage.',
  'dataManagement.googleDrive.connect': 'Connect Google Drive',
  'dataManagement.googleDrive.sync': 'Sync Full Backup to Drive',
  'dataManagement.googleDrive.restore': 'Restore Latest from Drive',
  'dataManagement.googleDrive.status.disconnected': 'Not connected.',
  'dataManagement.googleDrive.status.connected': 'Connected.',
  'dataManagement.googleDrive.status.lastSync': 'Last sync: {time}',
  'dataManagement.googleDrive.status.missingClientId':
    'Missing Google Drive client ID. Set VITE_GOOGLE_DRIVE_CLIENT_ID to enable sync.',
  'dataManagement.googleDrive.syncSuccess': 'Google Drive backup synced.',
  'dataManagement.googleDrive.error.authFailed': 'Google Drive authorization failed.',
  'dataManagement.googleDrive.error.syncFailed': 'Google Drive sync failed. Please try again.',
  'dataManagement.googleDrive.error.restoreFailed':
    'Google Drive restore failed. Please try again.',
  'dataManagement.googleDrive.error.noBackupFound': 'No backup found in Google Drive.',
