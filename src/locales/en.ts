...
export const en = {
  ...
  "import.success": "Import successful! Imported {lists} lists ({merged} merged, {added} new books)",
  "import.undoMessage": "Imported {lists} book lists ({merged} merged, {added} new books). Undo will restore to pre-import state.",
